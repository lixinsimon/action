	...
	<view>
		...
		<view class="querendingdan">
				...
				<view v-for="(l,i) in shu.gouwuchelie">
					<view class="items"  v-for="(s,k) in l.shangpin">
						...
						<view class="items_xiangqing">
							...
							<view class="items_jiage">和券{{s.jiage}}</view>
		    ...
		    <view class="weibu">
				...
				<view class="qufukuan" @click="XiaDingDan">去兑换</view>
		    </view>
		</view>
		</form>
...
<style>	
	...
	.kuang{width: 100vw;height: 120upx;display: flex;padding:10upx;box-sizing:border-box;background: white;}
	.kuang icon{width: 10%;font-size: 36upx;text-align: center;margin-top: 20upx;}
	.dizhi_center{width: 80%;}
	.dizhi_center_top{width: 100%;display: flex;}
