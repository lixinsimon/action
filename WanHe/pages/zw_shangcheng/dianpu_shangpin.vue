<template>
	<view>
		...
		<swiper :current="index" @change="bindChange" :style="'height:'+gaodu+'px;'">
			<swiper-item >
				<scroll-view scroll-y="true" class="lie_view" :style="'height:'+gaodu+'px;'">
...
<script>
	...
	uni.getSystemInfo({
			success: function (res) {		
					gaodu=Number(res.windowHeight)*Number(0.83); 						
			}
	});
	export default {
		data:{
...
<style>
	...
	/* .head{width: 100vw;padding: 0;margin: 0;box-sizing: border-box;z-index: 1000;height: 204upx;} */
	...
	.anniu_xiajia{position: absolute;width: 114upx;height: 56upx;display: flex;top:110upx;right:0;border-radius: 10upx;
				justify-content: center;align-items: center;font-size: 24upx;color: white;background: #1c2536;}
