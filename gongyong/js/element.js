	...
	return function(e) {
				...
				Jumper: {
					...
					methods: {
						...
						handleKeyUp: function(e) {
							var t = e.key || "",
								i = e.keyCode || "";
							(t && "Enter" === t || i && 13 === i) && this.handleChange({
								target: e.target
							})
						},
						handleChange: function(e) {
		...
		t.default = {
			...
			methods: {
				...
				handleKeyEnter: function(e) {
					this.suggestionVisible && this.highlightedIndex >= 0 && this.highlightedIndex < this.suggestions.length && (e.preventDefault(), this.select(this.suggestions[this.highlightedIndex]))
				},
				select: function(e) {
					var t = this;
		...
		t.default = {
			...
			methods: {
				...
				handleItemClick: function(e) {
					var t = e.index,
						i = e.indexPath;
					this.activeIndex = e.index, this.$emit("select", t, i, e), ("horizontal" === this.mode || this.collapse) && (this.openedMenus = []),
			...
			computed: {
				...
				form: function() {
					for(var e = this.$parent, t = e.$options.componentName;
						"ElForm" !== t;) "ElFormItem" === t && (this.isNested = !0),
						e = e.$parent, t = e.$options.componentName;
					return e
				},
				fieldValue: {
					cache: !1,
		...
		var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
			...
			u = function() {
				function e(t) {
					var i = this;
					s(this, e), this.currentNode = null,
