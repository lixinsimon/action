...
(function(b) {
	...
	c.prototype = {
		...
		constructor: function() {
			...
			d = this.htmlInput() + '<label for="' + g + '" class="' + this.options.classButton + '">' + this.htmlIcon() + "<span>" + this.options.buttonText + "</span></label>";
			this.$elementFilestyle = b('<div class="bootstrap-filestyle" style="display: inline;">' + d + "</div>");
			this.$element.css({
				position: "fixed",
				left: "-500px"
			...
			this.$element.change(function() {
				...
				if(h !== "") {
					f.$elementFilestyle.find(":text").val(h.replace(/\, $/g, ""))
				}
			});
		...
		var g = "",
			f = this.each(function() {
				if(b(this).attr("type") === "file") {
					var i = b(this),
						j = i.data("filestyle"),
						h = b.extend({}, b.fn.filestyle.defaults, e, typeof e === "object" && e);
					if(!j) {
