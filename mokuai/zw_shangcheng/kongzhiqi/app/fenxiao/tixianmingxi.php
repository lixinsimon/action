...
//	$zhuangtai=array('daishenhe'=>0,'daidakuan'=>10,'yidakuan'=>20,'wuxiao'=>5);
	...
	$tixianfangshi=array('yinhang'=>'银行','zhifubao'=>'支付宝');	
	...
	foreach($shu['lie'] as &$l){
		$l['zhuangtai_text']=$zhuangtai_text[$l['zhuangtai']];
		$sj=$l[$shijianzu[$l['zhuangtai']]];
		if($sj){
		  $l['shijian']=date('Y-m-d H:i',$sj);
		}else{
			 $l['shijian']=date('Y-m-d H:i',$l['shenqingshijian']);
		}
		$l['tixianfangshi']=$tixianfangshi[$l['tixianfangshi']];
