...
if ($cao == 'moren' && $_W['ispost']){
     ...
     $tj='';
     if($_J['cha']=='weiyong'){
     	 $tj='huiyuan='.$_W['huiyuan']['id'].' and danyuan='.$_W['danyuan'].' and  zhuangtai=0 and jieshu_shijian >'.time();
     }elseif($_J['cha']=='yiyong'){
     	 $tj='huiyuan='.$_W['huiyuan']['id'].' and danyuan='.$_W['danyuan'].' and zhuangtai !=0';
     }elseif($_J['cha']=='guoqi'){
     	 $tj='huiyuan='.$_W['huiyuan']['id'].' and danyuan='.$_W['danyuan'].' and jieshu_shijian <='.time();
     }
