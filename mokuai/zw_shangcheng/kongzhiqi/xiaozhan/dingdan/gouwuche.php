...
if($cao=='moren' && $_W['ispost']){
	$ziduan="gwc.*,sp.ming,sp.jiage,sp.kucun,sp.tu,sp.kuaidifei,sp.zhongliang,sp.zhuangtai,gg.guige_xuanze_ming,gg.guige_xuanze_kucun,gg.guige_xuanze_jiage,gg.guige_xuanze_zhongliang";
